- Getting started with ship-secure-frontend project

# Cloning

From https://github.com/Snowwhite-Workshop/ship-secure-frontend copy the url under code section
...
$ cd ship-secure-frontend/ (the newly cloned folder)
